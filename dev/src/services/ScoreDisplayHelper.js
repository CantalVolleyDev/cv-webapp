app.factory('ScoreDisplayHelper', function() {
  return {
    ...
    display4thSet: function() {
      return this.initialized && (this.data.match.firstScore + this.data.match.secondScore > 3);
    },
    display5thSet: function() {
      return this.initialized && (this.data.match.firstScore + this.data.match.secondScore > 4);
    },
